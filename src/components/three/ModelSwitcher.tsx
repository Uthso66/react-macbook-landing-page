...
function fadeMeshes(group: Group | null, opacity: number): void {
  if (!group) return;
...
function moveGroup(group: Group | null, x: number): void {
  if (!group) return;
...
function ModelSwitcher({ scale, isMobile }: ModelSwitcherProps) {
